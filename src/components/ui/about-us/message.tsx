...
export const Message = () => {
  return (
    <div className="space-y-4 md:space-y-8">
      ...
      >
        <div className="flex-1 p-4 space-y-2 border border-gray/50">
          <div className="space-y-1">
            <Img src="/icons/hospital.svg" alt="icon hospital" className="mx-auto size-12" />
            <h5 className="text-base lg:text-xl font-bold text-primary">Alamat</h5>
          </div>
          <p>Jl. Pulau Seram No.1, Dauh Puri Klod, Kec. Denpasar Bar., Kota Denpasar, Bali 80113</p>
        </div>
        <div className="flex-1 p-4 space-y-2 border border-gray/50">
          <div className="space-y-1">
            <Img src="/icons/call-sharp.svg" alt="icon hospital" className="mx-auto size-12" />
            <h5 className="text-base lg:text-xl font-bold text-primary">Hubungi Kami</h5>
          </div>
          <div className="space-y-1">
            <p>Call Center</p>
            <p>(0361) 226866</p>
        ...
        <div className="flex-1 p-4 space-y-2 border border-gray/50">
          <div className="space-y-1">
            <Img src="/icons/time.svg" alt="icon hospital" className="mx-auto size-12" />
            <h5 className="text-base lg:text-xl font-bold text-primary">Jam Operasional</h5>
          </div>
