  ...
  return (
    <div className="w-full text-light">
      <div className="flex flex-col lg:flex-row w-full lg:gap-4 xl:gap-8 bg-light">
        <Img src="/images/mission.png" alt="mission image" className="w-full min-h-72 xl:min-h-300" cover />
      ...
      <div className="flex flex-col-reverse lg:flex-row w-full lg:gap-4 xl:gap-8 bg-light">
        ...
        <Img src="/images/vision.png" alt="vision image" className="w-full min-h-72 xl:min-h-300" cover />
      </div>
    </div>
  );
};
